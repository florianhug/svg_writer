...
class PolygonSpec
  ...
  val properties: Seq[Property] = Seq(Property.stroke("black"), Property.strokeWidth(2), Property.fill("none"))
  ...
  "A Polygon" should "serialize to an svg element" in {
    ...
    assert(svgResult.get === "<polygon points=\"432.85,160.733 454.997,168.84 456.96,196.593 453.602,201.513 421.765,191.113\" stroke=\"black\" stroke-width=\"2\" fill=\"none\" />")
  }
